        ...
        >
            <View style={onboardingStyles.mainContent}>
                ...
                <Text style={styles.notificationText}>
                    Turning on notifications allows you to get the most out of Nightlife and stay up to date
                </Text>

                <TouchableOpacity onPress={handleNotification} style={styles.button}>
                    <Text style={onboardingStyles.nextButtonText}>Allow notifications</Text>
                </TouchableOpacity>
